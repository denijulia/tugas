...
<head>
    <title>Deret Arimatika Deni</title>
    <meta charset="utf-8">
            ...
            <div class="col-12 col-md-5">
                <form method="POST" action="#" class="bg-white form-container p-3" id="forminput">
                    ...
                    <div class="form-group" >
                        ...
                        <h4 style="background-color:violet"; color: white;; text-align: center; border-radius: 4px;"><?php echo $barishasil; ?></h4>
                    </div>
                    <div class="form-group">
                        <h4 style="text-align: center;">Nilai suku ke-n (Un)</h4>
                        <h4 style="background-color:violet"; color: white;; text-align: center; border-radius: 4px;"><?php echo $hasil; ?></h4>
                    </div>
                </form>
            </div>
        </div>
